                    ...
                    <div class="col-12">
                        <form action="{{ route('auth.doLogin')  }}" method="post">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="email" class="form-control form-control-lg @error("email") is-invalid @enderror" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1" value="{{ old("email") }}" name="email">
                            </div>
                            @error("email")
