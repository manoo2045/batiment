...
{{--                    </li>--}}
                    ...
                    <li class="sidebar-item">
                        <a href="{{ url('/admin/devis/liste') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Devis </span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('/finition/liste') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Finition </span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('/travaux/liste') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
                            <span class="hide-menu">Traveau</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a href="{{ url('/import') }}" class="sidebar-link">
                            <i class="mdi mdi-av-timer"></i>
